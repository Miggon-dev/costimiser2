...
def _synthesize_diagnosis_plus_cost_driver_plus_shap_plus_knowledge_plus_recommendations(
    execution_out: Dict[str, Any]
) -> str:
    diagnosis_text = ""
    driver_text = ""
    ...
    if driver_text:
        parts.append("Main contributing drivers\n\n" + driver_text)
    if shap_text:
        parts.append("Model sensitivity\n\n" + shap_text)
    if recommendation_text:
        parts.append(recommendation_text)
...
def _synthesize_diagnosis_plus_cost_driver_plus_shap_plus_knowledge_plus_recommendations_plus_scenario(
    execution_out: Dict[str, Any]
) -> str:
    diagnosis_text = ""
    driver_text = ""
...
def synthesize_execution(execution_out: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if final_template == "diagnosis_plus_cost_driver":
        ...
        text = _synthesize_diagnosis_plus_cost_driver_plus_shap_plus_knowledge_plus_recommendations(
            execution_out
        )
    elif final_template == "diagnosis_plus_cost_driver_plus_shap_plus_knowledge_plus_recommendations_plus_scenario":
        text = _synthesize_diagnosis_plus_cost_driver_plus_shap_plus_knowledge_plus_recommendations_plus_scenario(
            execution_out
        )     
    else:
