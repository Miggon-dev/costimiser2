...
def main():
    ...
    parser.add_argument("--ewm_halflife", type=str, default=DEFAULT_EWM_HALFLIFE,
                        help="EWM halflife for both X and y (e.g. '120min', '4h', '8h')")
    ...
    ts_transformed[Y_COLUMN] = y_series.groupby(seg).transform(
        lambda s: ewm_filter(s, halflife=args.ewm_halflife)).values
